...
export function setupTransactionForms() {
...
function initializeTransferForm() {
    ...
    const fromAccountId = transferForm.querySelector('[name="from_account_id"]');
    ...
    const accountIdField = transferForm.querySelector('[name="account_id"]');
...
async function populateAccountDropdown() {
    const toAccountDropdown = document.querySelector('#transfer-form [name="to_account_id"]');
    const fromAccountDropdown = document.querySelector('#transfer-form [name="from_account_id"]');
    if (!toAccountDropdown || !fromAccountDropdown)
        return;
    try {
        const apiClient = new ApiClient();
...
//# sourceMappingURL=transaction-forms.js.map