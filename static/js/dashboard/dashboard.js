...
function renderBalanceSummary(totalBalance) {
...
function setupAccountSelectionEvents(accounts) {
...
function showTransactionModal(type, accountId) {
    ...
    const accountIdField = modal.querySelector('[name="account_id"]');
            ...
            new Chart(ctx, {
                ...
                data: {
                    ...
                    datasets: [
                        ...
                        {
                            label: 'Withdrawals',
                            data: dailyData.withdrawals.map(val => -val),
...
function getTransactionColorClass(transaction) {
...
function getDefaultTransactionDescription(transaction) {
...
function getDailyTransactionData(transactions, dates) {
